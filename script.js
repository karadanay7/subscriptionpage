...
document.querySelector('.x-btn').addEventListener('click', ()=>{
    ...
    document.querySelector('.container').style.cssText=' background: linear-gradient(rgba(0,0,0,.5),rgba(0,0,0,.5)) ,url(./izmir.jpeg) center no-repeat; background-size:cover';
});